...
QWidget* TextTool::widget()
{
    ...
    // m_widget->setTextColorAndBackground(m_color, QColor("#FF0000"));
    m_widget->setTextColorAndBackground(QColor("#FFFF00"), QColor("#FF0000"));
...
void TextTool::process(QPainter& painter, const QPixmap& pixmap)
{
    ...
    // painter.fillRect(m_textArea, QColor(Qt::red));
    painter.fillRect(m_textArea, QColor(Qt::black));
    const int val = 5;
